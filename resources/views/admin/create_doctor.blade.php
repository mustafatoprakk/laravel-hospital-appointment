                    ...
                    <div class="col-md-8 offset-md-2">
                        <form action="{{ route('create-doctor') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control form-control-lg text-light bg-dark" id="name" name="name">
                            </div>
                            <div class="mb-3">
                              <label for="phone" class="form-label">Phone</label>
                              <input type="text" class="form-control form-control-lg bg-dark text-light" name="phone" id="phone">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg bg-dark text-light" name="room" id="room">
                            </div>
                            <div class="mb-4">
